...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, Pedido> consumerFactory() {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "cocina_group");
        props.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);
        props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, ErrorHandlingDeserializer.class.getName());
        props.put(ErrorHandlingDeserializer.VALUE_DESERIALIZER_CLASS, JsonDeserializer.class.getName());

        // Confianza en el paquete com.facturacion.model
        props.put(JsonDeserializer.TRUSTED_PACKAGES, "com.facturacion.model");
